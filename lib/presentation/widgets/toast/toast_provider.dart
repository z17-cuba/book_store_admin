...
class ToastWithColor extends ToastProvider {
  ...
  const ToastWithColor.success({
    ...
    this.textStyle,
    this.maxLines = 2,
    this.backgroundColor = AppColors.greenSuccess,
    this.borderColor,
    this.radius = 12,
    this.height,
    this.isLightBackground = false,
  ...
  const ToastWithColor.error({
    ...
    this.textStyle,
    this.maxLines = 2,
    this.backgroundColor = AppColors.redError,
    this.borderColor,
    this.radius = 12,
    this.height,
    this.isLightBackground = false,
...
class ToastWithoutColor extends ToastProvider {
  ...
  const ToastWithoutColor.success({
    ...
    this.textStyle,
    this.maxLines = 2,
    this.iconColor = AppColors.greenSuccess,
    this.radius = 12,
    this.height,
  }) : super();
  ...
  const ToastWithoutColor.error({
    ...
    this.textStyle,
    this.maxLines = 2,
    this.iconColor = AppColors.redError,
    this.radius = 12,
    this.height,
  }) : super();
